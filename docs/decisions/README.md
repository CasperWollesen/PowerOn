...
Short records of choices that are expensive to reverse. One file per decision,
newest last. A decision is never rewritten; if it changes, add a new record and
