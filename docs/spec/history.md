...
- Below: level badge relative to the shown period, the hours of the low and high,
  the average, and (not in Simple) the cheapest 3 hours and the weather.
...
- Each bar runs from the day's lowest to its highest hour, with a tick at the average.
